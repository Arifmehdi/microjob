    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="my-works" class="table dt-table-hover" style="width:100%">
                        <thead>
                        <tr>
                            <th>#ID</th>
                            <th>{{ __('Task Name') }}</th>
                        ...
                        @foreach($works as $work)
                            <tr>
                                ...
                                <td>
                                    @if($work->status === 'completed')
                                        {{ $work->per_worker_amount ? balanceFormat($work->per_worker_amount): balanceFormat() }}
                                    @else
                                        {{ balanceFormat() }}
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('works.show',$work->id) }}"
                                       class="btn btn-success btn-sm">{{ __('Details') }}</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
