                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="password">{{ __('Password') }} -
                                            ({{ __('Please leave it blank, if you do not want to update password.') }}
                                            )</label>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="balance" id="balance"
                                               ...
                                               value="{{ old('balance') ?? balanceFormat($user->balance,false) ?? '' }}"
                                               step="0.001">
                                        @error('balance')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label class="switch s-dark mr-2">
                                            <input type="checkbox" name="is_admin"
                                                   id="is_admin" {{ old('is_admin') ? 'checked' : ($user->is_admin ? 'checked' :'') }}>
                                    ...
                                    <div>
                                        <label class="switch s-dark mr-2">
                                            <input type="checkbox" name="status"
                                                   id="status" {{ old('status') ? 'checked' : ($user->status ? 'checked' :'') }}>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                    @error('status')
